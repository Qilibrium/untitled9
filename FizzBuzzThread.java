...
class FizzBuzzThread {
    ...
    FizzBuzzThread(Semaphore semFizz, Semaphore semBuzz, Semaphore semFizzBuzz, Semaphore semNumber) {
        this.semFizz = semFizz;
        this.semBuzz = semBuzz;
        this.semFizzBuzz = semFizzBuzz;
...
class Number{
    public static void main(String[] args) {
        FizzBuzzThread fizzBuzzThread = new FizzBuzzThread(15);
        ...
        Thread threadD = new Thread(() -> {
            try {
                fizzBuzzThread.number(printNumber);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
